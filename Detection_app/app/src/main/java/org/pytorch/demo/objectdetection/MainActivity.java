...
public class MainActivity extends AppCompatActivity implements Runnable {
    ...
    private String[] mTestImages = {"voiture_1.jpeg", "voiture_2.jpg", "voiture_3.png"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //bouton pour naviguer entre les images
        ...
        //bouton pour choisir image sur le périphérique
        ...
        //bouton pour faire tourner le modele sur la camera en direct
        final Button buttonLive = findViewById(R.id.liveButton);
        showPhoneWritePermission(); //ask for permission to write into storage
