...
public class PrePostProcessor {
    ...
    private static int mOutputColumn = 14; // left, top, right, bottom, score and 80 class probability
    private static float mThreshold = 0.8f; // score above which a detection is generated
